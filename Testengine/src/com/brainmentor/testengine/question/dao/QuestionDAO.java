package com.brainmentor.testengine.question.dao;
...
public ArrayList<QuestionDTO>getQuestions() throws ClassNotFoundException, SQLException
{
	...
	pstmt = connection.prepareStatement(Query.Questions_Fetch_SQL);
	...
	public void bulkUpload(ArrayList<QuestionDTO> questionList)  throws SQLException, ClassNotFoundException 
		...
		try{
			...
			pstmt = connection.prepareStatement(Query.QUESTION_UPLOAD_SQL);
			...
			for(QuestionDTO question : questionList){
				...
				pstmt.setString(4, question.getAns1());
